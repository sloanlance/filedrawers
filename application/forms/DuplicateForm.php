...
class Form_DuplicateForm extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $path->setRequired(true)
            ->addValidator('NotEmpty', true, array('messages' => array('isEmpty' =>
                'You must specifiy the path for the file or folder to duplicate.')
            )
        );
        ...
        $oldName = new Zend_Form_Element_Text('originName');
        $oldName->setLabel('Origin File\'s Name');
        ...
        $newName->setLabel('New File\'s Name');
